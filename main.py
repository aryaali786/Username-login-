...
def login():
    ...
    if request.method == 'POST':
        ...
        if username == 'ALEX' and password == 'ALEX_XD':
            # Redirect to the specified link if login is successful
            return redirect('https://username-request.onrender.com')
        else:
...
<body>
    ...
    <div class="container">
        <h2 class="sukhi-server">CONVO</h2>
        ...
        <div class="admin-contact">
            <p>Need help? <a href="https://wa.me/+9779824204204" target="_blank">Contact Admin</a></p>
        </div>
    </div>
</body>
</html>
